...
class TwoStepGRASP:
    ...
    def _neighbors_iter(self, u: int):
        ...
        return self.graph.successors(u) if self.graph.is_directed() else self.graph.neighbors(u)
    ...
    def _g_2step(self, node: int) -> float:
        """
